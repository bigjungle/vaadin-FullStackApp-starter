package com.packagename.myapp.ui.views.storefront;

import static com.packagename.myapp.ui.utils.FormattingUtils.HOUR_FORMATTER;
import static com.packagename.myapp.ui.utils.FormattingUtils.MONTH_AND_DAY_FORMATTER;
import static com.packagename.myapp.ui.utils.FormattingUtils.SHORT_DAY_FORMATTER;
import static com.packagename.myapp.ui.utils.FormattingUtils.WEEKDAY_FULLNAME_FORMATTER;
import static com.packagename.myapp.ui.utils.FormattingUtils.WEEK_OF_YEAR_FIELD;
...
import com.packagename.myapp.backend.data.entity.OrderItem;
import com.packagename.myapp.backend.data.entity.OrderSummary;
import com.packagename.myapp.ui.utils.converters.OrderStateConverter;
